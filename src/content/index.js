...
const handleMouseUp = async (e) => {
  ...
  const isInThisElement = document
    .querySelector("#simple-translate")
    ?.contains(e.target);
...
const removeTranslateContainer = async () => {
  ...
  translateContainerRoot?.unmount(element);
...
const showTranslateContainer = (
  ...
  translateContainerRoot = createRoot(document.getElementById("simple-translate"));
  translateContainerRoot.render(
    <TranslateContainer

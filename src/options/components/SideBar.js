      ...
      <ul>
        <li
          className={`sideBarItem ${
            ["/shortcuts", "/information"].every(path => path !== location.pathname)
              ? "selected"
              : ""
          }`}
        >
        ...
        {isValidShortcuts && (
          <li className={`sideBarItem ${location.pathname === "/shortcuts" ? "selected" : ""}`}>
            <Link to="/shortcuts">{browser.i18n.getMessage("shortcutsLabel")}</Link>
          </li>
        )}
        <li className={`sideBarItem ${location.pathname === "/information" ? "selected" : ""}`}>
